...
// GetMetricValue fetches the SLI values from dynatrace provider
func (d *keptnDynatraceDQLProvider) GetMetricValue(ctx context.Context, metric v1alpha2.KeptnMetric, provider v1alpha2.KeptnMetricProvider) (string, []byte, error) {
...
func (d *keptnDynatraceDQLProvider) ensureDTClientIsSetUp(ctx context.Context, provider v1alpha2.KeptnMetricProvider) error {
